<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="LT.WebApp.WebApp.SysManager.Dict.Detail" %>
...
<body>
    <form id="formDict" class="formCls" method="post" enctype="multipart/form-data">
        <fieldset>
            <table>
                <tr>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //父级选择信息的添加
            $('#F_ParentId').combobox({
                url: basePath + 'Ashx/SysManager/DictHandler.ashx?action=FindSelectTree',
                required: true,
