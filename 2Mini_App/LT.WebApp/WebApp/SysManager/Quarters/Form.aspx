<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form.aspx.cs" Inherits="LT.WebApp.WebApp.SysManager.Quarters.Form" %>
        ...
        <form id="formQuarters" class="formCls" method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td class="formValue">
                        <input name="F_Remark" multiline="true" class="easyui-textbox" data-options="width:260,height:60" />
                    </td>
                </tr>
            </table>
