<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="LT.WebApp.WebApp.SysManager.Quarters.Detail" %>
...
<body>
    <form id="formQuarters" class="formCls" method="post" enctype="multipart/form-data">
        <table>
            <tr>
                <th class="formTitle">岗位编号：</th>
                <td class="formValue">
                    <input id='F_Code' name="F_Code" type="text" class="easyui-textbox"
                        disabled="disabled" />
                </td>
                <th class="formTitle">岗位名称：</th>
                <td class="formValue">
                    <input id='F_Name' name="F_Name" type="text" class="easyui-textbox"
                        disabled="disabled" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th class="formTitle" style="line-height: 50px">备注：</th>
                <td class="formValue" colspan="3">
                    <input name="F_Remark" multiline="true" class="easyui-textbox" data-options="width:380,height:60" disabled="disabled" />
                </td>
            </tr>
            <tr>
