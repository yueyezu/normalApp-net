<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="LT.WebApp.WebApp.SysManager.DictItem.Detail" %>
                ...
                <tr>
                    ...
                    <td class="formValue">
                        <label for='F_IsDefault_true'>
                            <input type="radio" id="F_IsDefault_true" name="F_IsDefault" value="1" checked="checked" disabled="disabled" />是
                        </label>
                        <label for='F_IsDefault_false'>
                            <input type="radio" id="F_IsDefault_false" name="F_IsDefault" value="0" disabled="disabled" />否
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="formValue" colspan="3">
                        <input id="F_Description" name="F_Description" class="easyui-textbox" data-options="multiline:true" style="width: 92%; height: 60px;" disabled="disabled" />
                    </td>
                </tr>
                <tr>
